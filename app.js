...
//this function takes the answerer information 
//and creates a new object for the DOM
var showAnswerer = function(user){
	...
	username.text(user.user.display_name); /*is this correct*/
